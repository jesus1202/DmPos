...
public class ClienteVO {
     ...
     * @return the docsunat
     */
    public String getDocsunat() {
        return docsunat;
    }

    /**
     * @param docsunat the docsunat to set
     */
    public void setDocsunat(String docsunat) {
        this.docsunat = docsunat;
    }
    ...
    /**
     * @param tpersona the tpersona to set
     */
